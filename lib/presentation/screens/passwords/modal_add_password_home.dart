...
import 'package:pass_guard/presentation/helpers/helpers.dart';
import 'package:pass_guard/presentation/screens/passwords/components/type_password.dart';
import 'package:pass_guard/presentation/screens/passwords/modal_choose_icon.dart';
import 'package:pass_guard/presentation/screens/passwords/modal_generate_password.dart';
                      ...
                      return TextButton(
                        ...
                        onPressed: () {
                          if(nicknameController.text.trim().isEmpty || emailController.text.trim().isEmpty || passwordController.text.trim().isEmpty){
                            return modalMessage(context,color: Colors.white, 'Some fileds are required');
                          }
